#ifndef LEPTONSCALECORRECTIONS_HH
#define LEPTONSCALECORRECTIONS_HH

#include <iostream>
#include <cassert>
#include <TRandom3.h>

Double_t correctedElectronEnergy( Double_t inputEnergy, Double_t scEta, Double_t R9, Int_t run, Int_t type, string targetDataset, Bool_t isMC, TRandom3 *random ) {
